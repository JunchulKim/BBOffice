...
public class SmartLiveon_ShockViewList extends Activity implements OnClickListener {
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_shockviewlist);
	...
	public void TopLayer_Init() {
		...
		Tv_title.setText(R.string.Main_ShockViewList); // 타이틀 입력
